...
describe('CreateAddressDto (RQ-AUTH-20/22)', () => {
  it.each<{ name: string; payload: Record<string, unknown>; valid: boolean }>([
    ...
    {
      name: 'solo campos obligatorios (sin ciudad ni cp)',
      payload: { label: 'Casa', text: 'Calle 1', latitude: 0, longitude: 0 },
      valid: true,
    },
    {
      name: 'label de 100 caracteres (límite)',
      payload: { ...base, label: 'a'.repeat(100) },
      valid: true,
    },
    {
      name: 'text de 300 caracteres (límite)',
      payload: { ...base, text: 'a'.repeat(300) },
      valid: true,
    },
    {
      name: 'city de 100 caracteres (límite)',
      payload: { ...base, city: 'a'.repeat(100) },
      valid: true,
    },
    {
      name: 'postalCode de 20 caracteres (límite)',
      payload: { ...base, postalCode: 'a'.repeat(20) },
      valid: true,
    },
    ...
    {
      name: 'postalCode de 21 caracteres',
      payload: { ...base, postalCode: 'a'.repeat(21) },
      valid: false,
    },
...
describe('UpdateAddressDto (RQ-AUTH-20)', () => {
  ...
  it.each<{ name: string; payload: Record<string, unknown>; valid: boolean }>([
    ...
    {
      name: 'longitud -180.0001 (fuera de rango)',
      payload: { longitude: -180.0001 },
      valid: false,
    },
