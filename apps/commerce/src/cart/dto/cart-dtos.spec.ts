...
describe('AddCartItemDto (RQ-CART-02/03)', () => {
  const cases: Array<{ name: string; payload: Record<string, unknown>; valid: boolean }> = [
    ...
    { name: 'sin opciones', payload: { productId: 'p1', quantity: 2, optionIds: [] }, valid: true },
    {
      ...
      payload: { productId: 'p1', quantity: 2, optionIds: ['opt1', 'opt2'] },
      valid: true,
    },
    {
      name: 'observaciones de 500 caracteres (límite)',
      payload: { productId: 'p1', quantity: 1, observations: 'a'.repeat(500) },
      valid: true,
    },
    ...
    {
      name: 'observaciones de 501 caracteres',
      payload: { productId: 'p1', quantity: 1, observations: 'a'.repeat(501) },
      valid: false,
    },
    {
      name: 'optionIds no es array',
      payload: { productId: 'p1', quantity: 1, optionIds: 'opt1' },
      valid: false,
    },
    {
      name: 'optionIds con número',
      payload: { productId: 'p1', quantity: 1, optionIds: [1] },
      valid: false,
    },
    {
      name: 'optionIds con objeto',
      payload: { productId: 'p1', quantity: 1, optionIds: [{}] },
      valid: false,
    },
  ]
...
describe('UpdateCartItemDto (RQ-CART-04)', () => {
  const cases: Array<{ name: string; payload: Record<string, unknown>; valid: boolean }> = [
    ...
    {
      name: 'observaciones de 500 caracteres (límite)',
      payload: { observations: 'a'.repeat(500) },
      valid: true,
    },
    ...
    {
      name: 'observaciones de 501 caracteres',
      payload: { observations: 'a'.repeat(501) },
      valid: false,
    },
